...
require_once get_template_directory() . '/configurateur/functions-configurateur-save.php';
require_once get_template_directory() . '/configurateur/functions-configurateur-admin.php';
